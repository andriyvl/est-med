...
<head>
    ...
    <title>Materialy | Medycyna estetyczna kosmetologia makiaż permanentny Lublin</title>
    <?php include 'metadane.html' ?>
</head>
<body>
   <?php $page = 'materialy'; include 'header.php' ?>
    <main>
...
<h2 class="text_center">Artykuły</h2>
    ...
    <!-- <a href="docs/Ginekomastia_got.pdf"><img src="pics/ginekomastia.jpg" alt=""></a>
    <div>
        <h3>Ginekomastia – czym jest i jak ją leczyć?</h3>
        <p>Ginekomastia jest coraz częściej występującą chorobą gruczo- łu piersiowego, która dotyka męskiej populacji bez względu na
        wiek. Podłożem schorzenia są najczęściej zaburzenia hormonal- ne prowadzące do przerostu gruczołu piersiowego. Coraz częściej
        problem ten dotyczy młodych mężczyzn, którzy w trosce o zdro- wą i ładną sylwetkę zażywają podczas uprawiania sportu środki
        stymulujące przyrost masy mięśniowej. Ginekomastia w starszym wieku pojawia się najczęściej jako efekt leków stosowanych
        w terapii przerostu gruczołu krokowego. Chorobę tę mogą rów- nież wywoływać: rak jądra, otyłość, zaburzenia funkcji tarczycy,
        przysadki i jąder. W świetle ostatnich badań ginekomastia jest sta- nem predysponującym do zachorowania na raka piersi, który
        nie jest już tylko problemem typowo damskim. Jak sobie z nią radzić? Słowa kluczowe: ginekomastia, tkanka tłuszczowa, lipoliza
